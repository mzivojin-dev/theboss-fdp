...
/// <summary>
/// Backs the one-time company/vehicle/driver Settings screen (spec stories 44-47). The
/// underlying <see cref="VehicleProfile"/> is a singleton row created on first load.
/// </summary>
public sealed partial class SettingsViewModel(IVehicleProfileRepository repository) : ObservableObject
{
